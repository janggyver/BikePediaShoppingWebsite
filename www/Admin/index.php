...
<script language="javascript" type="text/javascript">
	...
	function setDeptCatOptions(DeptChosen) {
			 ...
			 switch (DeptChosen) {
			 		...
			 		case "Bike" : 
  			 			 catbox.options[catbox.options.length] = new Option(\'Road\',\'Road\');
  						 catbox.options[catbox.options.length] = new Option(\'MTB\',\'MTB\');
  						 catbox.options[catbox.options.length] = new Option(\'City\',\'City\');
						 break;
			
					case "Clothing" :
  			   			 catbox.options[catbox.options.length] = new Option(\'Jacket\',\'Jacket\');
  			   			 catbox.options[catbox.options.length] = new Option(\'Pants\',\'Pants\');
						 catbox.options[catbox.options.length] = new Option(\'Cap\',\'Cap\');
			   			 break;
			
					case "Equipment" :
  			   			 catbox.options[catbox.options.length] = new Option(\'Helmet\',\'Helmet\');
  			   			 catbox.options[catbox.options.length] = new Option(\'Eyewear\',\'Eyewear\');
  			   			 catbox.options[catbox.options.length] = new Option(\'Lights\',\'Lights\');
			   			 break;
			}
...
<div id="Main">
	...
	if($_SESSION["Admin"]==False){
			echo '<h1> You don\'t have any authority for this page. </h1>';	
	...
	if ( isset($_FILES["uploadedfile"]) ) {
		...
		echo ( isset($_POST['txtProductCode']) ? 'Product ID : ' . $_POST['txtProductCode'] . '<br>' : " " );
		
		// Where our fullsized image is going .
		$target_path = "../". $_POST['optDept']. "/Images/";

		
		
		// Where our thumbnail is going 							 	
		 $thumbnail_path = "../". $_POST['optDept']. "/Images/";

			
			
		// The name of our file, extracted from the original filename of the image you uploaded.   	
		//$filename = basename($_FILES["uploadedfile"]["name"]);
		$filename= $_POST['txtProductCode'].".jpg";		
...
// function CreateThumbnail() ends here.																	
	...
	$Department =isset($_POST['optDept'])?$_POST['optDept']:"Temp5";
	$Category =isset($_POST['optCat'])?$_POST['optCat']:"Temp6";
	$RegularPrice =isset($_POST['txtRegularPrice'])?$_POST['txtRegularPrice']:"15.00";
	$SalePrice =isset($_POST['txtSalePrice'])?$_POST['txtSalePrice']:10.00;
	$SaleStartDate =isset($_POST['txtSaleStartDate'])?$_POST['txtSaleStartDate']:"temp";
	$SaleEndDate =isset($_POST['txtSaleEndDate'])?$_POST['txtSaleEndDate']:"temp";
	...
	$Option1d =isset($_POST['txtOption1dDesc'])?$_POST['txtOption1dDesc']:33;
	$Stock =isset($_POST['txtStock'])?$_POST['txtStock']:10;
	...
	if(($resultRegisteredProdID->fetch_array(MYSQLI_ASSOC)) == $ProductCode){
	...
	<form name = "frmDeleteProduct" enctype="multipart/form-data" action="index.php" method="POST">
		...
		Product ID: <input type = "text" name="txtProdDeleteID" value="BIKE108"> <input type = "submit" value = "Delete Product">
	</form>
		<br/><br/><br/>
	...
	<a href="index.php">Reload page (without uploading anything)</a> <br>
		...
		<div id="RegForm" >
			...
			<div class="RegFormFullColSecond">
				<input type="text" name="txtProductName" size="25" maxlength="25" value="Please type Product Name">
			</div>
			<br><br>
			...
			<div class="RegFormFullColSecond">
				<input type="text" name="txtRegularPrice" size="25" maxlength="25" value="100.00">
			</div>
			...
			<div class="RegFormFullColSecond">
				<input type="text" name="txtSalePrice" size="25" maxlength="25" value="95.99">
			</div>			
			...
			<div class="RegFormFullColSecond">
				<input type="date" name="txtSaleStartDate" size="25" maxlength="25" value="2016-12-06">
			</div>			
			...
			<div class="RegFormFullColSecond">
				<input type="date" name="txtSaleEndDate" size="25" maxlength="25" value="2016-12-31">
			</div>			
			...
			<div class="RegFormFullColSecond">
				<input type="text" name="txtStock" size="25" maxlength="25" value="11">
			</div>				
