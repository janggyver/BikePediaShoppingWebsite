...
$strLanguage  = $_POST["optLanguage"];
$strFavCourse = $_POST["cboCourse"];
...
$strCPP 	  	= isset($_POST['chkCpp'])		 	?		$_POST['chkCpp']  	 		:"";

$strVisualBasic = isset($_POST['chkVisualbasic'])	?		$_POST['chkVisualbasic'] 	:"";
$strPHP 		= isset($_POST['chkPhp'])		 	?		$_POST['chkPhp']		 	:"";
$strJava 		= isset($_POST['chkJava'])		 	?		$_POST['chkJava']			:"";
$strOracle 		= isset($_POST['chkOracle'])	 	?		$_POST['chkOracle']			:"";
$strHex 		= isset($_POST['chkHex'])		 	?		$_POST['chkHex']		 	:"";
