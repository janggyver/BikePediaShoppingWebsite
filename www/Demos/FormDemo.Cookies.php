...
<form name="frmMyForm3" action="formdemo.php" onreset="return confirm('Do you really want to reset the form? Eric Added')">
		...
		<table border="1" cellpadding="3" style="border-collapse: collapse" bordercolor="#cccccc" width="500" bgcolor="#ffffff" height="142">
		   ...
		   <tr>		   	   
		   	   <td width="250" height="38">
				   ...
				   <font face="arial">
				   		<input type="text" name="txtFirstname" size="30" maxlength="20" value="<?php echo $strFirstName; ?>">
				   </font>
			   </td>
			   <td width="250" height="38">
			   	   <font size="2" face="arial">Last Name<br></font>
				   <font face="arial"> 
				   		 <input type="text" name="txtLastname" size="30" maxlength="20" value="<?php echo $strLastName ?>" >
				   </font>
			   </td>
		  </tr>
		  ...
		  <tr>
		  	  <td width="250" height="38">
				  ...
				  <font face="arial">
				  		<input type="radio"  name="optLanguage" value="English" <?php echo ($strLanguage=='English')?('CHECKED="CHECKED"'):('') ?> >
				  </font>
				  <font size="2" face="arial"> English&nbsp; </font>
				  <font face="arial"> 
				  		<input type="radio" name="optLanguage" value="Français" <?php echo ($strLanguage=='Français')?('CHECKED="CHECKED"'):('') ?> >
				  </font>
				  <font size="2" face="arial"> Français&nbsp; </font>
				  <font face="arial">
				  		<input type="radio" name="optLanguage" value="Español" <?php  echo ($strLanguage=='Español')?('CHECKED="CHECKED"'):('') ?> >
				  </font>
		...
		<tr>
			<td width="500" height="36" colspan="2">
				<font size="2" face="arial">
				  ...
				  <input type="checkbox" name="chkCpp" value="cpp" <?php if($strCPP=="yes") echo 'Checked="CHECKED"'; ?> > C++&nbsp;
				  <input type="checkbox" name="chkVisualbasic" value="visualbasic" <?php if($strVisualBasic=="yes") echo 'Checked="CHECKED"'; ?>  > Visual Basic&nbsp;
				  <input type="checkbox" name="chkPhp" value="php" <?php if($strPHP=="yes") echo 'Checked="CHECKED"'; ?> > PHP&nbsp;
				  <input type="checkbox" name="chkJava" value="java" <?php if($strJava=="yes") echo 'Checked="CHECKED"'; ?> > Java&nbsp;
				  <input type="checkbox" name="chkOracle" value="oracle" <?php if($strOracle=="yes") echo 'Checked="CHECKED"'; ?> > Oracle&nbsp;
				  <input type="checkbox" name="chkHex" value="hex" <?php if($strHex=="yes") echo 'Checked="CHECKED"'; ?> > Hex! 
				</font>
			</td>
	   </tr>
