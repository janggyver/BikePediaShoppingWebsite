...
// "Database Connectivity"
	...
	// 1. Create a connection to the local database
	$db_connected = new mysqli($db_server, $db_user, $db_passwd, $db_name); 
...
// "Retrieve Desired Record Set"
	...
	$strSQL = "SELECT ID, Category, Image, Price, Description, Option1Desc, Option1a, Option1b, Option1c, Option1d, Option2Desc, Option2a, 
		Option2b, Option2c, Option2d FROM Products order by Category,ID";
...
<font color="#ff0000">Records retrieved :: </font><?php echo $rows_returned; ?> <br /><br />
</b></p>
...
// "Display Individual Records"
  ...
  // 	"fetch_array(MYSQLI_ASSOC)" is a function that reads a single record (row) from the provided (rsProd) recordset.	
