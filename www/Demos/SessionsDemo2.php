...
<body>
	  ...
	  <?php
		   ...
		   echo '<h3>Deregister var1 (see source code)...</h3>';
	  	   unset($_SESSION["var1"]);

	  	   echo '<h3>Trying to use var1 ( without isset ) after it has been destroyed causes error, <br />but var2 and var3 should be unaffected...</h3>';
	  	   echo 'The content of $_SESSION[\'var1\'] is *' . $_SESSION["var1"] . '*<br />';
		   echo 'The content of $_SESSION[\'var2\'] is *' . $_SESSION["var2"] . '*<br />';
		   echo 'The content of $_SESSION[\'var3\'] is *' . $_SESSION["var3"] . '*<br /><br />';
		   ...
		   echo '<h3>Trying to use var1 ( with isset ) after it has been destroyed prevents error, <br />var2 and var3 remain unaffected...</h3>';
