...
$strFirstName = $_GET["txtFirstname"];
 
$strLastName  = $_GET["txtLastname"];
$strLanguage  = $_GET["optLanguage"];
$strFavCourse = $_GET["cboCourse"];
...
$strCPP 	  	= isset($_GET['chkCpp'])		 	?		$_GET['chkCpp']  	 	:"";

$strVisualBasic = isset($_GET['chkVisualbasic'])	?		$_GET['chkVisualbasic'] :"";
$strPHP 		= isset($_GET['chkPhp'])		 	?		$_GET['chkPhp']		 	:"";
$strJava 		= isset($_GET['chkJava'])		 	?		$_GET['chkJava']		:"";
$strOracle 		= isset($_GET['chkOracle'])	 		?		$_GET['chkOracle']		:"";
$strHex 		= isset($_GET['chkHex'])		 	?		$_GET['chkHex']		 	:"";
...
<p><hr>
	<font size="2" face="arial"> 
		  ...
		  <?php echo $strCPP; echo $strVisualBasic; echo $strPHP; echo $strJava; echo $strOracle; echo $strHex; ?>
	</font>
<hr></p>
