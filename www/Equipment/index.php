	...
	<div id="Search"> 
		 ...
		 <div id="YouAreHereList">
			 ...
			 <form action="">
				  ...
				  if ($PageID == 300){
				  		echo '		  
						<option value="/../equipment/index.php?PageID=300" selected="selected">'.$strCategory.'</option>
				        <option value="/../equipment/index.php?PageID=301"> Eyewear </option>
                        <option value="/../equipment/index.php?PageID=302"> Lights </option>';
				  }
				  else if ($PageID == 301){
				  		echo '		  

						<option value="/../equipment/index.php?PageID=300">Helmet</option>
				        <option value="/../equipment/index.php?PageID=301" selected="selected">'.$strCategory.'</option>
                        <option value="/../equipment/index.php?PageID=302">Lights</option>';
				  }
				  else if ($PageID == 302){
				  		echo '		  
						...
						<option value="/../equipment/index.php?PageID=300">Helmet</option>
				        <option value="/../equipment/index.php?PageID=301" >Eyewear</option>
                        <option value="/../equipment/index.php?PageID=302" selected = "selected">'.$strCategory.'</option>';
				  }
