...
<html>
	...
	// Return type :			TRUE if all validation passed, FALSE otherwise.
			...
			if (success) {
				...
				//Title  - to retrieve in reg.php, I used index number
				document.cookie = "TitleIndex=" + dCRF.cboTitle.selectedIndex + ";" + strExpDate;
				// also, I wrote actual text what was selected in the dropdown...
				var which=dCRF.cboTitle.selectedIndex;
				document.cookie = "TitleText=" + dCRF.cboTitle[which].text + ";" + strExpDate;

				
				// Province
				document.cookie = "ProvinceIndex=" + dCRF.cboProvince.selectedIndex + ";" + strExpDate;
				
				var provinceSelected = dCRF.cboProvince.selectedIndex;
				document.cookie = "ProvinceText=" + dCRF.cboProvince[provinceSelected].text + ";" + strExpDate;
				
				// Credit Card related
				document.cookie = "CreditCardIndex=" + dCRF.cboCreditCard.selectedIndex + ";" + strExpDate;
				var CreditCardSelected = dCRF.cboCreditCard.selectedIndex;
				
				document.cookie = "CreditCardText=" + dCRF.cboCreditCard[CreditCardSelected].text + ";" + strExpDate;
				

				document.cookie = "ExpiryMonthIndex= " + dCRF.cboMonth.selectedIndex + ";" + strExpDate;
				document.cookie = "ExpiryMonthText=" + dCRF.cboMonth[dCRF.cboMonth.selectedIndex].text + ";" + strExpDate;
				
				document.cookie = "ExpiryYearIndex=" + dCRF.cboYear.selectedIndex + ";" + strExpDate;
				document.cookie = "ExpiryYearText=" + dCRF.cboYear[dCRF.cboYear.selectedIndex].text + ";" + strExpDate;
...
<!--Main -->
<div id="Main">
	<h1> Please fill out the form with your information for registration. </h1>
	...
	<form 	name="frmCustReg"
		...
		<div id="RegForm" >
			...
			<div class="RegFormFullColSecond">
				<input type="password" name="txtPassword" size="25" maxlength="25" value="1111" id="passwordoriginal">
			</div>
			...
			<div class="RegFormFullColSecond">
				<input type="password" name="txtConfirmPassword" size="25" maxlength="25" value="1111" id="passwordconfirm">
			</div>
