...
<div id="Main">
	...
	<form 	name="frmCustReg"
		...
		<div id="RegForm" >
			...
			<div class="RegFormFullColSecond">
				<input type="text" name="txtPassword" size="25" maxlength="25" value="<?php echo $strPassword ?>">
			</div>
			...
			<div class="RegFormFullColSecond">
				<input type="text" name="txtConfirmPassword" size="25" maxlength="25" value="<?php echo $strConfirmPassword ?>">
			</div>
			...
			<div class="RegFormButtons">
					<input type="submit" value="Confirm" name="cmdConfirmButton">
