...
--
-- Host: 127.0.0.1
-- Generation Time: 16-11-18 03:40
-- 서버 버전: 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `ajaxdemo` (
...
--
-- 테이블의 덤프 데이터 `ajaxdemo`
--

INSERT INTO `ajaxdemo` (`id`, `name`, `comment`) VALUES
(1, 'aaa', '213131'),
(2, 'fsafsa', 'fsafas'),
(3, 'fsaf', 'fsafs'),
(4, 'dsa', 'fdsfa'),
...
(70, 'joe@nbcc.com', '38d17c89bbb30dc9e2665c7359356aaa08c63a4d', 'Mrs.', 'xyz', '587', '506', '634', '1265', '506', '663', '1232', '53 Hill Heights Road', 'Saint John, E2K 2B1', 'New Brunswick', 'VISA', 'June', 'Eric Jang', 'Espanol', '2018', 'd422adc7bff0b975bdc39e2e68139e6ef2963f30'),
(71, 'joe@nbcc.ca', '8cb2237d0679ca88db6464eac60da96345513964', 'Mrs.', 'Joe', 'Marriott', '506', '634', '1265', '506', '663', '1232', '53 Hill Heights Road', 'Saint John, E2K 2B1', 'New Brunswick', 'VISA', 'June', 'Eric Jang', 'Espanol', '2018', 'd422adc7bff0b975bdc39e2e68139e6ef2963f30');
...
('CLOT201', 'Sugoi RPM Shorts', 'Sugoi`s RPM Shorts are excellent for everyday riding. Constructed from 8 panels of Sugoi`s soft, quick-drying P3 fabric these shorts will keep you dry and comfortable. Plus, their luxurious S.100 chamois uses seamless molded construction with a soft, brushed surface while the flat elastic waist, flatlock seams and wide leg bands enhance all-around comfort. ', 'Pants', 'Clothing', 141, 60, 0, '0000-00-00', '0000-00-00', 'Size', 'Small', '', '', '', 0),
...
INSERT INTO `reviews` (`reviewid`, `ProductCode`, `CustomerName`, `CustomerEmail`, `Review`, `Rating`) VALUES
(62, 'CLOT101', 'Joe M', 'joe@nbcc.ca', 'First Review', 1);
