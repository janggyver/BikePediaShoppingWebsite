...
//				text_color_onmouseover,background_color_onmouseover,[items]] 
  ...
  LeftMenuLinks =[
	...
	['Bike','/bike/index.php','','black','white','black','#EAEFF4',
			   [
			   	['Road','/bike/index.php','_self','#000000','#ffffff','#000000','#bbcbdb'],

				['MTB','/bike/mtb.php', '_self', '#000000', '#ffffff', '#000000', '#bbcbdb'],

				['City','/bike/city.php','_self','#000000','#ffffff','#000000','#bbcbdb']

			   ]
	],
	
	['Clothing','/clothing/index.php','','black','white','black','#EAEFF4',
			   [
			   	['Jacket','/clothing/index.php?PageID=200','_self','#000000','#ffffff','#000000','#bbcbdb'],

				['Pants','/clothing/index.php?PageID=201', '_self', '#000000', '#ffffff', '#000000', '#bbcbdb'],

				['Cap','/clothing/index.php?PageID=202','_self','#000000','#ffffff','#000000','#bbcbdb']

			   ]
	],
	
	['Equipment','/equipment/index.php','','black','white','black','#EAEFF4',
			   [
			   	['Helmet','/equipment/index.php?PageID=300','_self','#000000','#ffffff','#000000','#bbcbdb'],

				['Eyewear','/equipment/index.php?PageID=301', '_self', '#000000', '#ffffff', '#000000', '#bbcbdb'],

				['Lights','/equipment/index.php?PageID=302','_self','#000000','#ffffff','#000000','#bbcbdb']
